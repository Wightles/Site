!function(t) {
    ...
    function i(a) {
        ...
        return t[a].call(r.exports, r, r.exports, i),
        r.l = !0,
        r.exports
    }
    i.m = t,
    ...
    class b {
        constructor(t={}) {
            if (!document.createElement("canvas").getContext)
                return void window.alert("HTML5 Canvas is not supported in your browser.");
            const {canvasId: e, debug: i, width: r, height: s, highResolution: n, loadLimit: o, soundOn: h} = t;
            let c = r || window.innerWidth
              , d = s || window.innerHeight;
            this.canvas = document.getElementById(e),
            n && (this.canvas.style.width = c + "px",
            ...
            this.calWidth = .5 * this.width,
            this.calHeight = .5 * this.height,
            this.debug = !!i,
        ...
        triggerReaction(t, e) {
            let i = t
              , a = e;
            this.highResolution && (i *= 2,
            a *= 2),
            this.instancesReactionArr.forEach(t=>{
                t.visible && i >= t.x && i <= t.x + t.width && a >= t.y && a <= t.y + t.height && t.trigger(t, this)
            }
            )
        }
        addAudio(t, e, i=0) {
        ...
        getVariable(t, e=null) {
            ...
            return i || (null !== e ? (this.setVariable(t, e),
            e) : null)
        }
        addImg(t, e, i=0) {
        ...
        drawDebug() {
            ...
            this.instancesReactionArr.forEach(t=>{
                t.visible && (this.ctx.strokeStyle = "red",
                this.ctx.beginPath(),
        ...
        getTimeMovement(t, e, i, a={}) {
            ...
            if (!h)
                return;
            h.processing || (this.timeMovementStartArr.push(t),
            h.store[o] = [],
            e.forEach(t=>{
                h.store[o].push({
            ...
            ;
            this.checkTimeMovement(t) ? c() : (this.timeMovementFinishArr.push(t),
            c(!0),
            s && s())
        }
        checkTimeMovement(t) {
        ...
        removeInstance(t, e=this.defaultLayer) {
            ...
            i && (this.instancesObj[e] = this.instancesObj[e].filter(e=>e.name !== t),
            i.trigger && (this.instancesReactionArr = this.instancesReactionArr.filter(e=>e.name !== t)))
        }
        updateInstances(t) {
        ...
        togglePaused() {
            ...
            this.paused ? this.lastPausedAt = t : this.pausedTime += t - this.lastPausedAt
        }
        ...
        load(t, e) {
            const i = setInterval(()=>{
                const a = this.assetsCount.image + this.assetsCount.audio
                  , r = Object.keys(this.assetsObj.image).length + Object.keys(this.assetsObj.audio).length;
                e && g(e) && e({
                    success: r,
                    failed: this.assetsErrorCount,
                    total: a
                }),
                this.assetsErrorQueue.length > 0 && (this.assetsErrorQueue.forEach(t=>{
                    const {retry: e, name: i, src: a, type: r} = t;
                    e >= this.loadLimit ? this.assetsErrorCount += 1 : "image" === r ? this.addImg(i, a, e) : this.addAudio(i, a, e)
                }
                ),
                this.assetsErrorQueue = []),
                r === a && (t && g(t) ? t() : this.init(),
                clearInterval(i))
            }
            , 200)
        }
    ...
    var O = "LAND"
      ...
      , p = function(t, e) {
        var i, a = t.getVariable("SUCCESS_COUNT"), r = t.getVariable("GAME_SCORE"), s = t.getVariable("GAME_USER_OPTION").hookSpeed;
        if (s)
            return s(a, r);
        switch (!0) {
        case a < 1:
        ...
        return t.getVariable("HARD_MODE") && (i = 1.1),
        Math.sin(e / (200 / i))
    }
      , E = function(t, e) {
      ...
      , x = function(t) {
        if (t.getVariable("GAME_START_NOW") && !(t.debug && t.paused || "HOOK_NORMAL" !== w(t))) {
            t.removeInstance("tutorial"),
            t.removeInstance("tutorial-arrow");
            var e = t.getInstance("block_".concat(t.getVariable("BLOCK_COUNT")));
            e && "SWING" === e.status && (t.setTimeMovement("HOOK_UP_MOVEMENT", 500),
      ...
      , L = function(t) {
        !function(t) {
            var e = t.ctx.createLinearGradient(0, 0, 0, t.height)
              , i = [[200, 255, 150], [105, 230, 240], [90, 190, 240], [85, 100, 190], [55, 20, 35], [75, 25, 35], [25, 0, 10]]
              , a = t.getVariable("BACKGROUND_LINEAR_GRADIENT_OFFSET_HEIGHT", 0);
            y(t) && t.setVariable("BACKGROUND_LINEAR_GRADIENT_OFFSET_HEIGHT", a + 1.5 * v(t));
        ...
        function(t) {
            ...
            r > t.height || (t.getTimeMovement("MOVE_DOWN_MOVEMENT", [[r, r + v(t, {
            ...
            t.getTimeMovement("BG_INIT_MOVEMENT", [[r, r + a / 4]], (function(t) {
                r = t
            }
            )),
            t.setVariable("BACKGROUND_IMG_OFFSET_HEIGHT", r),
            t.setVariable("LINE_INITIAL_OFFSET", t.height - .394 * a),
            t.ctx.drawImage(e, 0, r, t.width, a))
        }(t)
    }
      , N = function(t, e, i) {
        var a = t;
        a.ready || (a.y = e.getVariable("LINE_INITIAL_OFFSET"),
        a.ready = !0,
        a.collisionX = e.width - e.getVariable("BLOCK_WIDTH")),
        e.getTimeMovement("MOVE_DOWN_MOVEMENT", [[t.y, t.y + v(e, {
            pixelsPerFrame: function(t) {
                return t / 2
            }
        })]], (function(e) {
      ...
      , S = function(t) {
        ...
        t.imgName = i(e > 6 ? ["c4", "c5", "c6", "c7", "c8"] : ["c1", "c2", "c3"])
    }
      , k = function(t, e) {
        if (!t.ready) {
            t.ready = !0,
            ...
            t.originX = t.x,
            t.ax = e.pixelsPerFrame(t.width * e.utils.random(.05, .08) * e.utils.randomPositiveNegative()),
            t.y = e.utils.random(r.y, 1.2 * r.y)
        }
        t.x += t.ax,
        (t.x >= t.originX + t.width || t.x <= t.originX - t.width) && (t.ax *= -1),
        y(e) && (t.y += 1.2 * v(e)),
        t.y >= e.height && (t.y = .66 * -e.height,
        t.count += 4,
        S(t))
    }
      , C = function(t, e) {
      ...
      , R = function(t, e, i) {
        ...
        t.ready || (t.x = e.width / 2,
        t.y = -1.5 * a,
        t.ready = !0),
        e.getTimeMovement("HOOK_UP_MOVEMENT", [[t.y, t.y - a]], (function(e) {
            t.y = e
        }
        ), {
            after: function() {
        ...
        e.getTimeMovement("HOOK_DOWN_MOVEMENT", [[t.y, t.y + a]], (function(e) {
            t.y = e
        }
        ), {
            name: "hook"
      ...
      , F = function(t, e, i) {
        ...
        "tutorial" !== s && (t.y += Math.cos(i / 200) * t.height * .01)
    }
      , D = function(t, e) {
        if (!e.checkTimeMovement("TUTORIAL_MOVEMENT") && "HOOK_NORMAL" === w(e)) {
            var i = e.ctx
              , a = t.name
              , r = e.getImg(a);
      ...
      , G = function(t, e) {
        "ROTATE_LEFT" === t.status ? t.y - t.width >= e.height && (t.visible = !1,
        t.status = T,
        _(e)) : t.y >= e.height && (t.visible = !1,
        t.status = T,
        _(e))
    }
      , H = function(t, e, i) {
        ...
        if (a.visible) {
            ...
            case "DROP":
                ...
                a.startDropTime = i,
                a.vy += a.ay * n,
                a.y += a.vy * n + .5 * a.ay * Math.pow(n, 2);
                var o = function(t, e) {
                  ...
                  , h = s.y - t.height
                  , c = function(t) {
                    t.originOutwardAngle = Math.atan(t.height / t.outwardOffset),
                    t.originHypotenuse = Math.sqrt(Math.pow(t.height, 2) + Math.pow(t.outwardOffset, 2)),
                    e.playAudio("rotate")
                };
                switch (o) {
                case 1:
                ...
                case 5:
                    ...
                    !function(t) {
                        ...
                        t.getVariable("HARD_MODE") && t.setVariable("ROPE_HEIGHT", t.height * t.utils.random(.35, .55)),
                        e && e(i)
                    }(e),
                    e.setTimeMovement("MOVE_DOWN_MOVEMENT", 500),
                    10 !== d && 15 !== d || e.setTimeMovement("LIGHTNING_MOVEMENT", 150),
                    t.y = h,
                    s.y = h,
                    s.x = a.x - a.calWidth,
                    s.collisionX = s.x + a.width;
                    var u = .3 * a.width;
                    (a.x > e.width - 2 * u || a.x < -u) && e.setVariable("HARD_MODE", !0),
                    5 === o ? (t.perfect = !0,
                    I(e, !0),
                    e.playAudio("drop-perfect")) : (I(e),
                    e.playAudio("drop"))
                }
                break;
            case O:
            ...
            case "ROTATE_RIGHT":
                ...
                if (l ? t.rotate > 1.3 : t.rotate < -1.3)
                    t.rotate += g / 8 * m,
                    t.y += e.pixelsPerFrame(.7 * e.height),
                    t.x += e.pixelsPerFrame(.3 * e.width) * m;
                else {
      ...
      , W = function(t, e) {
        ...
        case "SWING":
            !function(t, e) {
                ...
                e.ctx.drawImage(i, t.weightX - t.calWidth, t.weightY, t.width, 1.3 * t.height);
      ...
      , K = function(t, e) {
        ...
        if (i) {
                ...
                var n = function(t, e) {
                    ...
                    return {
                        bottomToTop: {
                            ...
                            y: a,
                            vx: 0,
                            vy: .7 * t.pixelsPerFrame(a) * -1
                        },
                        leftToRight: {
                            x: -1 * s,
                            y: a * r(.3, .6),
                            vx: .4 * t.pixelsPerFrame(i),
                            vy: .1 * t.pixelsPerFrame(a) * -1
                        },
                        rightToLeft: {
                            x: i,
                            y: a * r(.2, .5),
                            vx: .4 * t.pixelsPerFrame(i) * -1,
                            vy: .1 * t.pixelsPerFrame(a)
                        },
                        rightTopToLeft: {
                            x: i,
                            y: 0,
                            vx: .6 * t.pixelsPerFrame(i) * -1,
                            vy: .5 * t.pixelsPerFrame(a)
                        }
                    }[e]
                }(e, r);
                t.ready = !0,
            ...
            t.x += t.vx,
            t.y += t.vy,
            (t.y + s < 0 || t.y > e.height || t.x + s < 0 || t.x > e.width) && (t.visible = !1)
        }
    }
      , j = function(t, e) {
        var i = e.ctx
      ...
      , X = function(t) {
        if (t.getVariable("GAME_START_NOW")) {
            ...
            var s = t.getImg("score")
              ...
              , h = .35 * t.width
              , c = o * h / n;
            t.ctx.drawImage(s, .61 * t.width, .038 * t.width, h, c),
            A(t, {
                string: a,
                size: .06 * t.width,
                x: .9 * t.width,
            ...
            for (var d = t.ctx, u = t.getImg("heart"), l = u.width, g = u.height, m = .08 * t.width, b = g * m / l, f = 1; f <= 3; f += 1)
                d.save(),
                f <= i && (d.globalAlpha = .2),
                d.drawImage(u, .66 * t.width + (f - 1) * m, .16 * t.width, m, b),
                d.restore()
        }
    }
      , Y = function(t) {
        if (t.getVariable("GAME_START_NOW")) {
            ...
            if (!e || [O, T].indexOf(e.status) > -1) {
                if (y(t) && v(t))
                    return;
                if (t.checkTimeMovement("HOOK_UP_MOVEMENT"))
                    return;
                var i = function(t) {
                  ...
                  , a = Math.PI * t.utils.random(i, i + 5) * t.utils.randomPositiveNegative() / 180;
    ...
    window.TowerGame = function() {
        ...
        s.setVariable("BLOCK_WIDTH", .25 * s.width),
        s.setVariable("BLOCK_HEIGHT", .71 * s.getVariable("BLOCK_WIDTH")),
        s.setVariable("CLOUD_SIZE", .3 * s.width),
        s.setVariable("ROPE_HEIGHT", .4 * s.height),
